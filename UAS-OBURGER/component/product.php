...
$tampil = mysqli_query($conn, "SELECT * FROM menu WHERE id_menu = '$_GET[id]' ");
...
if (isset($_POST['submit'])) {
    ...
    $men = $_POST['id_menu'];
    $jum = $_POST['jumlah'];
                $sql = "INSERT INTO keranjang (id_user, id_menu, jumlah)
                VALUES ('$us', '$men', '$jum')";
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__pic">
                        ...
                        <div class="product__details__pic__slider owl-carousel">
                            <img data-imgbigurl="<?php echo $image; ?>"
