...
$makanan = mysqli_query($conn, "SELECT * FROM menu WHERE  kategori LIKE 'makanan'");
while($makanan2=mysqli_fetch_assoc($makanan)){
    $data1[] = $makanan2;
}
?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="featured__controls">
                        <ul>
                        <li class="active"><a href="dashboard.php">Makanan</a></li>
